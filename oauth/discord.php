...
if ($result0->rowCount() > 0){
  ...
  $sql = "INSERT INTO `account_users` (`method`, `id`, `username`, `avatar`, `level`, `creation`) VALUES ('discord', '".$_SESSION['userid']."', '".$_SESSION['username']."', '".$_SESSION['avatar']."', '1', CURRENT_TIMESTAMP);";
  $result = $db->query($sql);
}
